...
export default function ProfessionalPreferences({ navigation }) { 

  const [pageHeader, setPageHeader] = useState("Edit Professional Preferences")
  ...
  <Picker style={mainStyle.pickerStyle}>
	<Picker.Item label="select" value="" /> 
            ...
            rules={{ required: true }}
          />
          <Text style={styles.label}>Employee In</Text>
          <Controller
            control={control}
            render={({field: { onChange, onBlur, value }}) => (
              <View style={mainStyle.select}>
