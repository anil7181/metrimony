...
export default function FamilyInfo({ navigation }) { 
  ...
  const [pageHeader, setPageHeader] = useState("Edit Family Info")
  ...
  const onSubmit = () => {  
    navigation.navigate('BasicPreferences')
  };
...
<View style={mainStyle.mainScreen}>
  ...
  <Picker style={mainStyle.pickerStyle}>
	<Picker.Item label="select" value="" /> 
        ...
        <Text style={styles.label}>Brother(s) Married</Text>
          <Controller
            control={control}
            render={({field: { onChange, onBlur, value }}) => (
              <View style={mainStyle.select}>
  ...
  <Picker style={mainStyle.pickerStyle}>
	<Picker.Item label="select" value="" /> 
        ...
        <Text style={styles.label}>Sister(s) Married</Text>
          <Controller
            control={control}
            render={({field: { onChange, onBlur, value }}) => (
              <View style={mainStyle.select}>
