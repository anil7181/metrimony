...
export default function LocationPreferences({ navigation }) { 

  const [pageHeader, setPageHeader] = useState("Edit Location Preferences")
  ...
  <Picker style={mainStyle.pickerStyle}>
	<Picker.Item label="select" value="" /> 
            ...
            rules={{ required: true }}
          />
          <Text style={styles.label}>Taluq</Text>
          <Controller
            control={control}
            render={({field: { onChange, onBlur, value }}) => (
              <View style={mainStyle.select}>
